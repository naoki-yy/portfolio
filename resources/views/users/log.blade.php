...
@section('content')
    ...
    <div class="row mt-5 mb-5">
        <div class="col-md-4">
            <div class="card">
                <h5 class="card-title text-center font-weight-bold pt-2">{{ $post->recommendation_point1 }}</h5>
                @if($post->recommendation_image1 !== null)
        ...
        <div class="col-md-4">
            <div class="card">
                <h5 class="card-title text-center font-weight-bold pt-2">{{ $post->recommendation_point2 }}</h5>
        ...
        <div class="col-md-4">
            <div class="card">
                <h5 class="card-title text-center font-weight-bold pt-2">{{ $post->recommendation_point3 }}</h5>
